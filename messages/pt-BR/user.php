 ...
 */
return array (
  '{attribute} should contain at least {n, plural, one{one character} other{# characters}} ({found} found)!' => '{attribute} deve conter pelo menos {n, plural, one{um caracter} other{# caracteres}} ({found} encontrado(s)!',
  '{attribute} should contain at most {n, plural, one{one character} other{# characters}} ({found} found)!' => '{attribute} deve conter no máximo {n, plural, one{um caracter} other{# caracteres}} ({found} encontrado(s))!',
  '{attribute} should contain exactly {n, plural, one{one character} other{# characters}} ({found} found)!' => '{attribute} deve conter exatamente {n, plural, one{um caracter} other{# caracteres}} ({found} encontrado(s))!',
  '{attribute} cannot contain any spaces' => '{attribute} não pode conter espaços',
  '{attribute} cannot contain the username' => '{attribute} não pode conter o nome do usuário',
  '{attribute} cannot contain an email address' => '{attribute} não pode conter o endereço de email',
  '{attribute} should contain at least {n, plural, one{one lower case character} other{# lower case characters}} ({found} found)!' => '{attribute} deve conter pelo menos {n, plural, one{uma letra minúscula} other{# letras minúsculas}} ({found} encontrado(s))!',
  '{attribute} should contain at least {n, plural, one{one upper case character} other{# upper case characters}} ({found} found)!' => '{attribute} deve conter pelo menos {n, plural, one{uma letra maiúscula} other{# letras maíúsculas}} ({found} encontrado(s))!',
  '{attribute} should contain at least {n, plural, one{one numeric / digit character} other{# numeric / digit characters}} ({found} found)!' => '{attribute} deve conter pelo menos {n, plural, one{um número} other{# números}} ({found} encontrados(s))!',
  '{attribute} should contain at least {n, plural, one{one special character} other{# special characters}} ({found} found)!' => '{attribute} deve conter pelo menos {n, plural, one{um caracter especial} other{# caracteres especiais}} ({found} found)!',
  'Are you sure you want to switch to this user for the rest of this Session?' => 'Tem certeza que quer trocar por este usuário?',
  'Are you sure?' => 'Tem certeza?',
  'Are you sure? There is no going back' => 'Tem certeza? Não será possível retornar',
  'Become this user' => 'Se torne este usuário',
  'Delete account' => 'Excluir conta',
  'Error while trying to generate new password' => 'Erro durante a geração da nova senha',
  'Generate and send new password to user' => 'Gere e envie uma nova senha para o usuário',
  'Impersonate user is disabled in the application configuration' => 'Acesso anônimo está desabilitado na configuração da aplicação',
  'It will be deleted forever' => 'Será excluído definitivamente',
  'Last login' => 'Último acesso',
  'Never' => 'Nunca',
  'New Password has been generated and sent to user' => 'Uma nova senha foi gerada e enviada para o usuário',
  'New rule' => 'Nova regra',
  'Not found' => 'Não encontrado',
  'Once you delete your account, there is no going back' => 'Uma vez excluída, não é possível recuperar a conta',
  'Password generation is not possible for admin users' => 'Geraação de senha não está acessível para usuários administrativos',
  'Password is not necessary because the module is in DEBUG mode.' => 'Senha não é necessária porque o módulo está em modo DEBUG.',
  'Please be certain' => 'Por favor, tenha certeza',
  'Registration on this website is disabled' => 'O cadastro neste site está desabilitado',
  'Rules' => 'Regras',
  'Time zone' => 'Fuso horário',
  'Time zone is not valid' => 'Fuso horário é invalido',
  'We have generated a password for you' => 'Nós geramos uma senha para vocÊ',
  'Your account has been completely deleted' => 'Sua conta foi definitivamente excluída',
  'Your account on {0} has a new password' => 'Sua conta em {0} tem uma nova senha',
  'Your password on {0} has been changed' => 'Sua senha em {0} foi alterada',
  ...
  'Already registered? Sign in!' => 'Já possui acesso? Clique aqui!',
  ...
  'Complete password reset on {0}' => 'Redefinição de senha em {0}',
  'Confirm' => 'Confirmar',
